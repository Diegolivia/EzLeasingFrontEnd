...
export class MessageService {
  ...
  add(message: LeasingData) {
    ...
    sessionStorage.setItem('leasdata', JSON.stringify(message))
    console.log("Message saved");
    console.log(sessionStorage.getItem('leasdata'))
  }

  get() {
    var val = sessionStorage.getItem('leasdata');
